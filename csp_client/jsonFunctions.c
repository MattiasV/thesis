...
void get_byte_data_in_json(json_object * jparameter, uint8_t * data, int * index_of_data){
	...
	for(int i = 0; i < sizeof(json_parameters)/(sizeof(char *)*2); i++){
		...
		int datatype;
		switch(json_parameters[i].parameter_type){
			...
			case u8:
				json_object_object_add(jparameter, json_parameters[i].parameter_key, json_object_new_int(data[*index_of_data++]));
				break;
			...
			case u16:
				...
				json_object_object_add(jparameter, json_parameters[i].parameter_key, json_object_new_int(fourBytesUnion.u16bytes[0]));
				break;

			case i16:
				fourBytesUnion.u8bytes[0] = data[*index_of_data++];
				fourBytesUnion.u8bytes[1] = data[*index_of_data++];
				json_object_object_add(jparameter, json_parameters[i].parameter_key, json_object_new_int(fourBytesUnion.i16bytes[0]));
				break;
			...
			case u32:
				...
				json_object_object_add(jparameter, json_parameters[i].parameter_key, json_object_new_int(fourBytesUnion.u32bytes));
				break;
			...
			case i32:
				...
				json_object_object_add(jparameter, json_parameters[i].parameter_key, json_object_new_int(fourBytesUnion.i32bytes));
				break;
			...
			case f32:
				...
				json_object_object_add(jparameter, json_parameters[i].parameter_key, json_object_new_double(fourBytesUnion.fbytes));
				break;

			case c:
				charparameter[0] = data[*index_of_data++];
				json_object_object_add(jparameter, json_parameters[i].parameter_key, json_object_new_string(charparameter));
				break;
			...
			case s:
				...
				json_object_object_add(jparameter, json_parameters[i].parameter_key, json_object_new_string(description));
				break;
			...
			case unk32:
				...
				break;
				case b:
					json_object_object_add(jparameter, json_parameters[i].parameter_key, json_object_new_boolean(data[*index_of_data++]));
					break;
